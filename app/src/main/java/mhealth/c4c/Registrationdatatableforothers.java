...
public class Registrationdatatableforothers extends SugarRecord {
    String name,lname,idnumber,age,mflcode,myhepa,username,password,gender,cadre,securityqn,securityans;

    public Registrationdatatableforothers(){

    }
    public Registrationdatatableforothers(String nm, String lname, String gender, String cadre, String idnum, String age, String code, String hepa, String uname, String pass, String securityQn, String securityAns){
