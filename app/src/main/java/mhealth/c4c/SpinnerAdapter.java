...
public class SpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(mys.contentEquals("choose a security question")||mys.contentEquals("Please Select Gender")||mys.contentEquals("Please Select Marital Status")||mys.contentEquals("Please Select Condition")||mys.contentEquals("Please Select Language")||mys.contentEquals("Please Select Status")||mys.contentEquals("Please Select Cadre")||mys.contentEquals("Enable Sms")||mys.contentEquals("Where did the exposure occur?")||mys.contentEquals("What was the type of exposure?")||mys.contentEquals("Have you been vaccinated against Hepatitis B?")||mys.contentEquals("select specialization")){
