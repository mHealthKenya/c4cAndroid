...
public class PendingVaccination extends Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v=inflater.inflate(R.layout.pending_vaccination_fragment,container,false);
        initialise();
        populateList();
    ...
    public void initialise(){
        ...
        try{
            ...
            recyclerView = (RecyclerView) v.findViewById(R.id.pending_vaccination_recycler_view);
    ...
    public void populateList(){
        ...
        try{
            ...
            List<Status> myl=Status.findWithQuery(Status.class,"select * from Status where category=?","pending vaccination");
            if(myl.size()>0){
