...
public class CreateUserForOthers extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.createuserforothers);
...
//            Toast.makeText(this, "going to previous", Toast.LENGTH_SHORT).show();
            Intent myintt=new Intent(getApplicationContext(), RegisterForOtherUserLoginData.class);
...
//                    spinnerDialog=new SpinnerDialog(CreateUser.this,items,"Select or Search City","Close Button Text");// With No Animation
                    spinnerDialog=new SpinnerDialog(CreateUserForOthers.this,y,"Select Facility",R.style.DialogAnimations_SmileWindow,"Close");// With 	Animation
        ...
        try {
            ...
            ageE.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    datePickerDialog = new DatePickerDialog(CreateUserForOthers.this,
...
//                        motherE.setVisibility(View.GONE);
                    ...
                    .setPositiveButton("Done!", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (itemsSelectedSpecialisation.size() > 1) {
                                Toast.makeText(CreateUserForOthers.this, "Select only one specialisation", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
    ...
    public void initialise() {
        ...
        try {
            ...
            //hepatitis b
            ut=new UpdateStatusTable(CreateUserForOthers.this);
            ...
            //hepatits b
            pr=new Progress(CreateUserForOthers.this);
            countyList=new ArrayList<>();
            facilityList=new ArrayList<>();
            subcountyList=new ArrayList<>();

            requestPerms=new RequestPerms(CreateUserForOthers.this,this);
//            chkInternet=new CheckInternet(CreateUser.this);
            accessServer=new AccessServer(CreateUserForOthers.this);
            ...
            grd = new GetRemoteData(CreateUserForOthers.this);
            sweetdialog = new Dialogs(CreateUserForOthers.this);
...
//        Registrationdatatable rt = Registrationdatatable.findById(Registrationdatatable.class, 1);
        Registrationdatatableforothers.executeQuery("update Registrationdatatableforothers set gender=?,cadre=?,idnumber=?,age=?,mflcode=?,myhepa=?",myselectedgender,myselected2,myidno,myage,mymfl,"-1");
...
//        et.save();
        ...
        accessServer.createProfileForOthers(partner.toString(),sspecial,myselectedgender,myselected2,myidno,myage,mymfl,newPhoneS,myoth);
...
//                    params.put(Config.KEY_BORROWINGSPOSTEMAIL, sessionEmail);
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(CreateUserForOthers.this);
...
//                            chi.save();
                            ...
                            List<Hepatitisforothers> myl=Hepatitisforothers.findWithQuery(Hepatitisforothers.class,"select * from Hepatitisforothers");
                            if(myl.size()>0){

                                Hepatitisforothers inf = Hepatitisforothers.findById(Hepatitisforothers.class, 1);
...
//                                Hepatitis.executeQuery("update Hepatitis set immunisedvaluedose1=? and immunisediddose1=?","Yes","2131296553");
                                ...
                                Hepatitisforothers inf=new Hepatitisforothers();
                                inf.setImmunisedvaluedose1("Yes");
                                inf.setImmunisediddose1("2131296553");
                                inf.save();
