package mhealth.c4c.reportExposureForOthers;
...
public class ReportForOthers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.report_for_others);
...
//                            sm.sendMultipartTextMessage(Config.shortcode, null, parts, null, null);
                            Toast.makeText(ReportForOthers.this, "Successfully submitted", Toast.LENGTH_SHORT).show();
...
//                        SignupsuccessDialog("");
    ...
    public void initialise(){
        ...
        try{
            ...
            sm=new SendMessage(ReportForOthers.this);
            dcalc=new DateCalculator();
            chkInternet=new CheckInternet(ReportForOthers.this);
            accessServer=new AccessServer(ReportForOthers.this);
            ...
            dtp=new DateTimePicker(ReportForOthers.this);
            sweetdialog=new Dialogs(ReportForOthers.this);
            ...
            SpinnerExposureDeep.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    try{
                        ...
                        Toast.makeText(ReportForOthers.this, "exception here "+e, Toast.LENGTH_SHORT).show();
